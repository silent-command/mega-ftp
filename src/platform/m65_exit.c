 ...
 * disk image mounted from BASIC stays mounted (measured: `RUN "FTPC"`
...
void m65_exit_to_basic(void)
{
  ...
  POKE(0xd068, 0x00); POKE(0xd069, 0xd8);          /* the ROM's lowercase set again, not the copy at $11000 (ssh 5.25) */
  POKE(0xd06a, 0x00);
